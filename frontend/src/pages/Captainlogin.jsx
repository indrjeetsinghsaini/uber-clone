...
const CaptainLogin = () => {
    // All your hooks and functions must be INSIDE the component
    const [email, setEmail] = useState('');
    const [password, setPassword] = useState('');
    const { setCaptain } = useContext(CaptainDataContext); // Use the imported useContext
    ...
    // The return statement is the last thing inside the component
    return (
